################################################################################
################### SbIII amastigotes Dose-response analysis #####################
################################################################################
...
DataSbIII<- read.csv(file = "Data/processed/DataSbIII_processed_normalized.csv", 
                     header = TRUE, sep = ,)
...
C89 <- filter(DataSbIII_SUM, pop == "C89")
C76 <- filter(DataSbIII_SUM, pop == "C76")
C67p <- filter(DataSbIII_SUM, pop == "C67p")
C68 <- filter(DataSbIII_SUM, pop == "C68")
...
# Differences was found between REF and C6, C58, C67, C73, C76, C67p e 68*
...
DoseResponseCurves04 <- ggplot() +
  ...
  DoseResponseCurves04 <- ggplot() +
    ...
    geom_line(data = newdata_C6, aes(x = log(conc, 10), y = viability_normalized), size = 0.5, color = "lightseagreen") +
    geom_line(data = newdata_C7, aes(x = log(conc, 10), y = viability_normalized, linetype = "LiGSH1 C7 (+/-)"), size = 1, color = "red") +
    ...
    geom_line(data = newdata_C67p, aes(x = log(conc, 10), y = viability_normalized), size = 0.5, color = "lightseagreen") +
    geom_line(data = newdata_C76, aes(x = log(conc, 10), y = viability_normalized, linetype = "LiPGPA C76 (+/-)"), size = 1, color = "red") +
    ...
    geom_line(data = newdata_C68, aes(x = log(conc, 10), y = viability_normalized), size = 0.5, color = "lightseagreen") +
    ...
    ylim(0, 115) +
    xlim(0.5, 2) +
    scale_linetype_manual(values = c("LiGSH1 C7 (+/-)" = "solid", "LiPGPA C76 (+/-)" = "dashed")) +
    theme_bw()
  
  
  
  DoseResponseCurves04 + 
  labs(linetype = expression("Clones com"~"ED"[50] > "ED"[50]~"LiGSH1 WT (+/+)"), size = 20)+
...
REF_AMA_SbIII <- (plot1+plot2+plot3) + plot_annotation(tag_levels = "A")
REF_AMA_SbIII
ggsave("Figuras/Fit_REF_AMA_SbIII.png", REF_AMA_SbIII)
...
C6_AMA_SbIII <- (plot1+plot2+plot3) + plot_annotation(tag_levels = "A")
C6_AMA_SbIII
ggsave("Figuras/Fit_C6_AMA_SbIII.png", C6_AMA_SbIII)
...
C7_AMA_SbIII <- (plot1+plot2+plot3) + plot_annotation(tag_levels = "A")
C7_AMA_SbIII
ggsave("Figuras/Fit_C7_AMA_SbIII.png", C7_AMA_SbIII)
...
C44_AMA_SbIII <- (plot1+plot2+plot3) + plot_annotation(tag_levels = "A")
C44_AMA_SbIII
ggsave("Figuras/Fit_C44_AMA_SbIII.png", C44_AMA_SbIII)
...
C58_AMA_SbIII <- (plot1+plot2+plot3) + plot_annotation(tag_levels = "A")
C58_AMA_SbIII
ggsave("Figuras/Fit_C58_AMA_SbIII.png", C58_AMA_SbIII)
...
C67_AMA_SbIII <- (plot1+plot2+plot3) + plot_annotation(tag_levels = "A")
C67_AMA_SbIII
ggsave("Figuras/Fit_C67_AMA_SbIII.png", C67_AMA_SbIII)
...
C73_AMA_SbIII <- (plot1+plot2+plot3) + plot_annotation(tag_levels = "A")
C73_AMA_SbIII
ggsave("Figuras/Fit_C73_AMA_SbIII.png", C73_AMA_SbIII)
...
C85_AMA_SbIII <- (plot1+plot2+plot3) + plot_annotation(tag_levels = "A")
C85_AMA_SbIII
ggsave("Figuras/Fit_C85_AMA_SbIII.png", C85_AMA_SbIII)
...
C76_PGPA_AMA_SbIII <- (plot1+plot2+plot3) + plot_annotation(tag_levels = "A")
C76_PGPA_AMA_SbIII
ggsave("Figuras/Fit_C76_PGPA_AMA_SbIII.png", C76_PGPA_AMA_SbIII)
...
C67_PGPA_AMA_SbIII <- (plot1+plot2+plot3) + plot_annotation(tag_levels = "A")
C67_PGPA_AMA_SbIII
ggsave("Figuras/Fit_C67_PGPA_AMA_SbIII.png", C67_PGPA_AMA_SbIII)
...
C68_PGPA_AMA_SbIII <- (plot1+plot2+plot3) + plot_annotation(tag_levels = "A")
C68_PGPA_AMA_SbIII 
ggsave("Figuras/Fit_C68_PGPA_AMA_SbIII.png", C68_PGPA_AMA_SbIII )
...
ggsave("Figures/DR_REF_SbIII.png", DR_REF)
...
ggsave("Figures/DR_Clones_GSH1_SbIII.png", DR_Clones_GSH1)
...
ggsave("Figures/DR_Clones_PGPA_SbIII.png", DR_Clones_PGPA)
