...
# Loading data
EXP1 <- read.csv(file = "Data/raw/sheets/GSH1/EXP1_SbIII_22042023.csv")
EXP2 <- read.csv(file = "Data/raw/sheets/GSH1/EXP2_SbIII_28042023.csv")
EXP3 <- read.csv(file = "Data/raw/sheets/GSH1/EXP3_SbIII_02052023.csv")
EXP4 <- read.csv(file = "Data/raw/sheets/GSH1/EXP4_SbIII_08052023.csv")
...
# PGPA
EXP1 <- read.csv(file = "Data/raw/sheets/PGPA/PGPA_SbIII_09072023T.csv")
EXP2 <- read.csv(file = "Data/raw/sheets/PGPA/PGPA_SbIII_14072023T.csv")
EXP3 <- read.csv(file = "Data/raw/sheets/PGPA/PGPA_SbIII_15072023T.csv")
