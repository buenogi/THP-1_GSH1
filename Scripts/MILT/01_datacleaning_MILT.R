...
# Loading data
EXP1 <- read.csv(file = "Data/raw/sheets/GSH1/EXP1_MILT_22042023.csv")
EXP2 <- read.csv(file = "Data/raw/sheets/GSH1/EXP2_MILT_28042023.csv")
EXP3 <- read.csv(file = "Data/raw/sheets/GSH1/EXP3_MILT_02052023.csv")
EXP4 <- read.csv(file = "Data/raw/sheets/GSH1/EXP4_MILT_08052023.csv")
...
# PGPA
EXP1 <- read.csv(file = "Data/raw/sheets/PGPA/PGPA_MIL_09072023T.csv")
EXP2 <- read.csv(file = "Data/raw/sheets/PGPA/PGPA_MIL_14072023T.csv")
EXP3 <- read.csv(file = "Data/raw/sheets/PGPA/PGPA_MIL_15072023T.csv")
...
write.csv(EXP_full, file = "Data/processed/EXP_full_MIL_corrected.csv")
