...
ggsave("Experiments/Figures/DoseResponseCurves_MIL_01.png")
...
ggsave("Experiments/Figures/DoseResponseCurves_MIL_02.png")
...
ggsave("Experiments/Figures/DoseResponseCurves_MIL_03.png")
...
# Differences was found between REF and C6, C58***, C67***,C73***, and C85**
# also between C6 and C7**,C44**,C58,C67,C73 and 685
# C7 and C58*, C67,C73,C85*
# C44 and C58*, C73***, C85*
# C58 and CC67** 
...
ggsave("Experiments/Figures/DoseResponseCurves_MIL_04.png")


#  Fit diagnostic

par(mfrow=c(1,3), cex.lab=1.2)
plot(REF$viability, fitted(REF_MIL.LL4), main="LL4", 
     xlab ="Adjusted values", ylab="Observed values", pch=16, cex=.7)
abline(a = 0,b = 1)
residuals(REF_MIL.LL4, typeRes = c("studentised"))
plot(fitted(REF_MIL.LL4),residuals(REF_MIL.LL4, 
                                   typeRes = c("studentised")), 
     main="LL4", xlab="Adjusted values", ylab="Residuals", pch=16, cex=.7)
lines(loess.smooth(fitted(REF_MIL.LL4), 
                   residuals(REF_MIL.LL4, typeRes = c("studentised"))))
abline(h=0, lty=2)
qqnorm(residuals(REF_MIL.LL4), xlab="Theoretical quantiles", 
       ylab="Residuals", main = "LL4")
qqline(residuals(REF_MIL.LL4))
...
par(mfrow=c(1,3), cex.lab=1.2)
plot(C6$viability, fitted(C6_MIL.LL4), main="LL4", 
     xlab ="Adjusted values", ylab="Observed values", pch=16, cex=.7)
abline(a = 0,b = 1)
residuals(C6_MIL.LL4, typeRes = c("studentised"))
plot(fitted(C6_MIL.LL4),residuals(C6_MIL.LL4, 
                                  typeRes = c("studentised")), 
     main="LL4", xlab="Adjusted values", ylab="Residuals", pch=16, cex=.7)
lines(loess.smooth(fitted(C6_MIL.LL4), 
                   residuals(C6_MIL.LL4, typeRes = c("studentised"))))
abline(h=0, lty=2)
qqnorm(residuals(C6_MIL.LL4), xlab="Theoretical quantiles", 
       ylab="Residuals", main = "LL4")
qqline(residuals(C6_MIL.LL4))

png("Figures/03_Fit_diagnostic_C6.png",  width = 6, height = 4, units = "in", res = 300)


par(mfrow=c(1,3), cex.lab=1.2)
plot(C7$viability, fitted(C7_MIL.LL4), main="LL4", 
     xlab ="Adjusted values", ylab="Observed values", pch=16, cex=.7)



abline(a = 0,b = 1)
residuals(C7_MIL.LL4, typeRes = c("studentised"))
plot(fitted(C7_MIL.LL4),residuals(C7_MIL.LL4, 
                                  typeRes = c("studentised")), 
     main="LL4", xlab="Adjusted values", ylab="Residuals", pch=16, cex=.7)
lines(loess.smooth(fitted(C7_MIL.LL4), 
                   residuals(C7_MIL.LL4, typeRes = c("studentised"))))
abline(h=0, lty=2)
qqnorm(residuals(C7_MIL.LL4), xlab="Theoretical quantiles", 
       ylab="Residuals", main = "LL4")
qqline(residuals(C7_MIL.LL4))

png("Figures/03_Fit_diagnostic_C7.png",  width = 6, height = 4, units = "in", res = 300)


par(mfrow=c(1,3), cex.lab=1.2)
plot(C44$viability, fitted(C44_MIL.LL4), main="LL4", 
     xlab ="Adjusted values", ylab="Observed values", pch=16, cex=.7)
abline(a = 0,b = 1)
residuals(C44_MIL.LL4, typeRes = c("studentised"))
plot(fitted(C44_MIL.LL4),residuals(C44_MIL.LL4, 
                                   typeRes = c("studentised")), 
     main="LL4", xlab="Adjusted values", ylab="Residuals", pch=16, cex=.7)
lines(loess.smooth(fitted(C44_MIL.LL4), 
                   residuals(C44_MIL.LL4, typeRes = c("studentised"))))
abline(h=0, lty=2)
qqnorm(residuals(C44_MIL.LL4), xlab="Theoretical quantiles", 
       ylab="Residuals", main = "LL4")
qqline(residuals(C44_MIL.LL4))

png("Figures/03_Fit_diagnostic_C44.png",  width = 6, height = 4, units = "in", res = 300)


par(mfrow=c(1,3), cex.lab=1.2)
plot(C58$viability, fitted(C58_MIL.LL4), main="LL4", 
     xlab ="Adjusted values", ylab="Observed values", pch=16, cex=.7)
abline(a = 0,b = 1)
residuals(C58_MIL.LL4, typeRes = c("studentised"))
plot(fitted(C58_MIL.LL4),residuals(C58_MIL.LL4, 
                                   typeRes = c("studentised")), 
     main="LL4", xlab="Adjusted values", ylab="Residuals", pch=16, cex=.7)
lines(loess.smooth(fitted(C58_MIL.LL4), 
                   residuals(C58_MIL.LL4, typeRes = c("studentised"))))
abline(h=0, lty=2)
qqnorm(residuals(C58_MIL.LL4), xlab="Theoretical quantiles", 
       ylab="Residuals", main = "LL4")
qqline(residuals(C58_MIL.LL4))
...
par(mfrow=c(1,3), cex.lab=1.2)
plot(GSH1$viability, fitted(GSH1_MIL.LL4), main="LL4", 
     xlab ="Adjusted values", ylab="Observed values", pch=16, cex=.7)
abline(a = 0,b = 1)
residuals(GSH1_MIL.LL4, typeRes = c("studentised"))
plot(fitted(GSH1_MIL.LL4),residuals(GSH1_MIL.LL4, 
                                    typeRes = c("studentised")), 
     main="LL4", xlab="Adjusted values", ylab="Residuals", pch=16, cex=.7)
lines(loess.smooth(fitted(GSH1_MIL.LL4), 
                   residuals(GSH1_MIL.LL4, typeRes = c("studentised"))))
abline(h=0, lty=2)
qqnorm(residuals(GSH1_MIL.LL4), xlab="Theoretical quantiles", 
       ylab="Residuals", main = "LL4")
qqline(residuals(GSH1_MIL.LL4))
...
par(mfrow=c(1,3), cex.lab=1.2)
plot(C67$viability, fitted(C67_MIL.LL4), main="LL4", 
     xlab ="Adjusted values", ylab="Observed values", pch=16, cex=.7)
abline(a = 0,b = 1)
residuals(C67_MIL.LL4, typeRes = c("studentised"))
plot(fitted(C67_MIL.LL4),residuals(C67_MIL.LL4, 
                                   typeRes = c("studentised")), 
     main="LL4", xlab="Adjusted values", ylab="Residuals", pch=16, cex=.7)
lines(loess.smooth(fitted(C67_MIL.LL4), 
                   residuals(C67_MIL.LL4, typeRes = c("studentised"))))
abline(h=0, lty=2)
qqnorm(residuals(C67_MIL.LL4), xlab="Theoretical quantiles", 
       ylab="Residuals", main = "LL4")
qqline(residuals(C67_MIL.LL4))

png("Figures/03_Fit_diagnostic_C67.png",  width = 6, height = 4, units = "in", res = 300)


par(mfrow=c(1,3), cex.lab=1.2)
plot(C73$viability, fitted(C73_MIL.LL4), main="LL4", 
     xlab ="Adjusted values", ylab="Observed values", pch=16, cex=.7)
abline(a = 0,b = 1)
residuals(C73_MIL.LL4, typeRes = c("studentised"))
plot(fitted(C73_MIL.LL4),residuals(C73_MIL.LL4, 
                                   typeRes = c("studentised")), 
     main="LL4", xlab="Adjusted values", ylab="Residuals", pch=16, cex=.7)
lines(loess.smooth(fitted(C73_MIL.LL4), 
                   residuals(C73_MIL.LL4, typeRes = c("studentised"))))
abline(h=0, lty=2)
qqnorm(residuals(C73_MIL.LL4), xlab="Theoretical quantiles", 
       ylab="Residuals", main = "LL4")
qqline(residuals(C73_MIL.LL4))
...
par(mfrow=c(1,3), cex.lab=1.2)
plot(C85$viability, fitted(C85_MIL.LL4), main="LL4", 
     xlab ="Adjusted values", ylab="Observed values", pch=16, cex=.7)
abline(a = 0,b = 1)
residuals(C85_MIL.LL4, typeRes = c("studentised"))
plot(fitted(C85_MIL.LL4),residuals(C85_MIL.LL4, 
                                   typeRes = c("studentised")), 
     main="LL4", xlab="Adjusted values", ylab="Residuals", pch=16, cex=.7)
lines(loess.smooth(fitted(C85_MIL.LL4), 
                   residuals(C85_MIL.LL4, typeRes = c("studentised"))))
abline(h=0, lty=2)
qqnorm(residuals(C85_MIL.LL4), xlab="Theoretical quantiles", 
       ylab="Residuals", main = "LL4")
qqline(residuals(C85_MIL.LL4))

png("Figures/03_Fit_diagnostic_C85.png",  width = 6, height = 4, units = "in", res = 300)

par(mfrow=c(1,3), cex.lab=1.2)
plot(C89$viability, fitted(C89_MIL.LL4), main="LL4", 
     xlab ="Adjusted values", ylab="Observed values", pch=16, cex=.7)
abline(a = 0,b = 1)
residuals(C89_MIL.LL4, typeRes = c("studentised"))
plot(fitted(C89_MIL.LL4),residuals(C89_MIL.LL4, 
                                   typeRes = c("studentised")), 
     main="LL4", xlab="Adjusted values", ylab="Residuals", pch=16, cex=.7)
lines(loess.smooth(fitted(C89_MIL.LL4), 
                   residuals(C89_MIL.LL4, typeRes = c("studentised"))))
abline(h=0, lty=2)
qqnorm(residuals(C89_MIL.LL4), xlab="Theoretical quantiles", 
       ylab="Residuals", main = "LL4")
qqline(residuals(C89_MIL.LL4))
