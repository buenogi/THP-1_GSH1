...
# Loading data
EXP1 <- read.csv(file = "Data/processed/EXP_full_ANF_corrected.csv")
...
ggsave("figs/01_infectivity_ANF.jpg")
...
AmaPcellplot <- ggplot(EXP_full, aes(fill= conc,
  ...
  ggtitle("Nº of amastigote per cell ANF dosage in different populations") +
...
ggsave("figs/02_AmaPcellplot_ANF.jpg")
...
ggsave("figs/03_lineplot_ANF.jpg")
...
ggsave("figs/04_lineplot_ANF_SUM.jpg")