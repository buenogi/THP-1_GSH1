...
DataANF <-  read.csv(file = "Experiments/Data/processed/DataANF_viability.csv")
...
DataANF_Full  <- rbind(REF,C6,C7,C44,C58, C67,C73,C85)


# CSV exportation

write.csv(DataANF_Full , file = "Experiments/Data/processed/DataANF_processed_normalized.csv", 
          sep = ",", row.names = F)
